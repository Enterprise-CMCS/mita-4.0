...
(function () {
  ...
  const sectionByFile = {
    ...
    'companion-guide.html': 'companion-guide.html',
    'outcomes-based-planning.html': 'outcomes-based-planning.html',
    'architectures.html': 'architectures.html',
    'information-architecture.html': 'architectures.html',
    'ia-data-crosswalks.html': 'architectures.html',
    'ia-maturity-criteria.html': 'architectures.html',
    'maturity-criteria.html': 'maturity-criteria.html',
    'ssa-tool.html': 'maturity-criteria.html',
    'tools-resources.html': 'tools-resources.html',
    'references.html': 'references.html',
    'site-map.html': 'references.html',
    'implementation-process.html': 'references.html'
  };

  function normalizePrimaryNavigation() {
    var file = window.location.pathname.split('/').pop() || 'index.html';
    var sectionFile = sectionByFile[file] || file;
    var parentHref = './' + sectionFile;
    var exactHref = './' + file + (window.location.hash || '');
    var fileHref = './' + file;

    document.querySelectorAll('.nav-main, .mobile-nav').forEach(function (nav) {
      ...
      nav.querySelectorAll('a').forEach(function (link) {
        ...
        var isParent = link.classList.contains('nav-parent') || link.classList.contains('mobile-nav-parent');
        var group = link.closest('.nav-item-group, .mobile-nav-group');

        if (href === parentHref && isParent) {
          link.classList.add('active');
          if (group) group.classList.add('active');
        }

        if (!isParent && (href === exactHref || (!window.location.hash && href === fileHref))) {
          link.classList.add('active');
        }
      });
    });
  ...
  window.addEventListener('hashchange', normalizePrimaryNavigation);
